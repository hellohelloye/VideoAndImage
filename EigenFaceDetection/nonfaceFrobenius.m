%..........................................................
%Yukui Ye HW4  full_e.m is for caculating nonface Images frobenius
%........................................................
clear;close all;clc;
%.........................................................................
...
%.........................................................................
%get nonface Image matrix
fileName2 = dir('C:\Users\yye_000\Documents\MATLAB\NonfaceImages\*.jpg');
numberImgs2 = length(fileName2);
testMatrix=zeros(1:205*175,1:numberImgs2);
for i= 1: numberImgs2
    x = imread( fileName2(i).name );
    x = double(rgb2gray(x));
    testMatrix(:,i) = reshape(x,205*175,numberImgs2);
end
%.......................................................................
...
mMatrix = zeros(17864,numberImgs2);
for i = 1:numberImgs
    for j = 1:numberImgs2
